...
<div {{ $attributes->merge(['class' => 'flex flex-col items-center justify-center py-12 px-4 ' . $class]) }}>
    <!-- Icon -->
    ...
    <!-- Description -->
    @if($description)
    <p class="text-gray-500 dark:text-gray-400 text-center max-w-sm mb-6">{{ $description }}</p>
    @endif
